...
public class Rank extends JFrame {
	...
	public Rank() throws Exception {
		...
		bgPanel = new JPanel() {
			ImageIcon i = new ImageIcon("img/record.png");
		...
		insertButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == insertButton) {
					jp.setName(insertField.getText());
					try {
						dao.insertMember(jp);
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == deleteButton) {
					try {
						dao.deleteMember(deleteField.getText());
	...
	public void tableRefresh() {
		try {
			JumpDAO dao = new JumpDAO();
			DefaultTableModel model = new DefaultTableModel(dao.listMember(), getColumn());
